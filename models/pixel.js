...
PixelSchema.methods.getInfo = function(overrideDataAccess = false, app = null) {
    return new Promise((resolve, reject) => {
        ...
        require("./user").getPubliclyAvailableUserInfo(this.editorID, overrideDataAccess, app).then(user(info) => resolve(Object.assign(info, userInfo))).catch((err) => reject(err));
    })
}
